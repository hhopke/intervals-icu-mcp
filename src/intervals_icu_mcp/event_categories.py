...
### Notes
- `NOTE` — generic calendar note, or a recovery-week note when generated
  by the Annual Training Plan builder. Use `icu_get_annual_training_plan`
  to read ATP recovery weeks alongside weekly load targets.
